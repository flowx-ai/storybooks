...
Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsPanelState> | undefined"}}}}}catch{}const ie={title:"Stepper",component:c,subcomponents:{FlxStepperItem:l,FlxStepperContent:o,FlxStepperList:d},decorators:[(t,{args:a})=>e.jsx("div",{style:{fontFamily:a.fontFamily},className:"flx-default-theme",children:e.jsx(t,{})})],argTypes:{fontFamily:{options:["Open Sans","Source Code Pro","Bitter"],control:{type:"select"}}}},J={args:{fontFamily:"Open Sans"}},F={...J,render:()=>e.jsxs(c,{children:[e.jsxs(d,{children:[e.jsx(l,{label:"Step 1",index:0}),e.jsx(l,{label:"Step 2",index:1}),e.jsx(l,{label:"Step 3",index:2})]}),e.jsx(o,{value:0,children:e.jsx("p",{children:'This is the contents of "Step 1"'})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 2"'})}),e.jsxs(o,{value:2,children:[e.jsx("p",{children:'This is the contents of "Step 3"'}),e.jsx("p",{children:"It can contain multiple elements"})]})]})},g={...J,render:()=>e.jsxs(c,{defaultValue:0,children:[e.jsxs(d,{children:[e.jsx(l,{label:"Step 1",index:0}),e.jsx(l,{label:"Step 2",index:1}),e.jsx(l,{label:"Step 3",index:2})]}),e.jsx(o,{value:0,children:e.jsxs("div",{children:[e.jsx("p",{children:'This is the contents of "Step 1"'}),e.jsxs(c,{children:[e.jsxs(d,{children:[e.jsx(l,{label:"Step 1.1",index:0}),e.jsx(l,{label:"Step 1.2",index:1}),e.jsx(l,{label:"Step 1.3",index:2})]}),e.jsx(o,{value:0,children:e.jsx("p",{children:'This is the contents of "Step 1.1"'})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 1.2"'})}),e.jsx(o,{value:2,children:e.jsx("p",{children:'This is the contents of "Step 1.3"'})})]})]})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 2"'})}),e.jsxs(o,{value:2,children:[e.jsx("p",{children:'This is the contents of "Step 3"'}),e.jsx("p",{children:"It can contain multiple elements"})]})]})};var w,j,E;F.parameters={...F.parameters,docs:{...(w=F.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...StepperTemplate,
  render: () => <FlxStepper>
      <FlxStepperList>
...
} satisfies Story`,...(H=(v=g.parameters)==null?void 0:v.docs)==null?void 0:H.source}}};const de=["SimpleStepper","MultiStepper"];export{g as MultiStepper,F as SimpleStepper,de as __namedExportsOrder,ie as default};
