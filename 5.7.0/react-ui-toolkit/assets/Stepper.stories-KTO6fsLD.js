...
Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsListState> | undefined"}}}}}catch{}try{C.displayName="MemoFlxStepperList",C.__docgenInfo={description:"",displayName:"MemoFlxStepperList",props:{render:{defaultValue:null,description:`Allows you to replace the component’s HTML element
with a different tag, or compose it with another component.

Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsListState> | undefined"}},className:{defaultValue:null,description:`CSS class applied to the element, or a function that
returns a class based on the component’s state.`,name:"className",required:!1,type:{name:"string | ((state: TabsListState) => string | undefined) | undefined"}},ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"((instance: HTMLDivElement | null) => void) | RefObject<HTMLDivElement> | null | undefined"}}}}}catch{}const o=t=>e.jsx(j,{...t,tabIndex:void 0}),L=n.memo(o);try{o.displayName="FlxStepperContent",o.__docgenInfo={description:"",displayName:"FlxStepperContent",props:{className:{defaultValue:null,description:`CSS class applied to the element, or a function that
...
Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsRootState> | undefined"}},parentIndex:{defaultValue:null,description:"",name:"parentIndex",required:!1,type:{name:"number | undefined"}}}}}catch{}try{I.displayName="FlxMemoStepper",I.__docgenInfo={description:"",displayName:"FlxMemoStepper",props:{render:{defaultValue:null,description:`Allows you to replace the component’s HTML element
with a different tag, or compose it with another component.

Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsRootState> | undefined"}},className:{defaultValue:null,description:`CSS class applied to the element, or a function that
returns a class based on the component’s state.`,name:"className",required:!1,type:{name:"string | ((state: TabsRootState) => string | undefined) | undefined"}},onValueChange:{defaultValue:null,description:"Callback invoked when new value is being set.",name:"onValueChange",required:!1,type:{name:"((index: number) => void) | undefined"}},parentIndex:{defaultValue:null,description:"",name:"parentIndex",required:!1,type:{name:"number | undefined"}},completedSteps:{defaultValue:null,description:"",name:"completedSteps",required:!0,type:{name:"number[]"}},ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"((instance: HTMLDivElement | null) => void) | RefObject<HTMLDivElement> | null | undefined"}}}}}catch{}try{FlxStepperItem.displayName="FlxStepperItem",FlxStepperItem.__docgenInfo={description:"",displayName:"FlxStepperItem",props:{completed:{defaultValue:{value:"false"},description:"",name:"completed",required:!1,type:{name:"boolean | undefined"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},className:{defaultValue:null,description:`CSS class applied to the element, or a function that
returns a class based on the component’s state.`,name:"className",required:!1,type:{name:"string | ((state: TabsTabState) => string | undefined) | undefined"}},render:{defaultValue:null,description:`Allows you to replace the component’s HTML element
with a different tag, or compose it with another component.
...
Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsListState> | undefined"}}}}}catch{}try{MemoFlxStepperList.displayName="MemoFlxStepperList",MemoFlxStepperList.__docgenInfo={description:"",displayName:"MemoFlxStepperList",props:{render:{defaultValue:null,description:`Allows you to replace the component’s HTML element
with a different tag, or compose it with another component.

Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsListState> | undefined"}},className:{defaultValue:null,description:`CSS class applied to the element, or a function that
returns a class based on the component’s state.`,name:"className",required:!1,type:{name:"string | ((state: TabsListState) => string | undefined) | undefined"}},ref:{defaultValue:null,description:"",name:"ref",required:!1,type:{name:"((instance: HTMLDivElement | null) => void) | RefObject<HTMLDivElement> | null | undefined"}}}}}catch{}try{FlxStepperContent.displayName="FlxStepperContent",FlxStepperContent.__docgenInfo={description:"",displayName:"FlxStepperContent",props:{className:{defaultValue:null,description:`CSS class applied to the element, or a function that
returns a class based on the component’s state.`,name:"className",required:!1,type:{name:"string | ((state: TabsPanelState) => string | undefined) | undefined"}},render:{defaultValue:null,description:`Allows you to replace the component’s HTML element
with a different tag, or compose it with another component.
...
Accepts a \`ReactElement\` or a function that returns the element to render.`,name:"render",required:!1,type:{name:"ReactElement<Record<string, unknown>, string | JSXElementConstructor<any>> | ComponentRenderFn<HTMLProps<any>, TabsPanelState> | undefined"}}}}}catch{}const ee={title:"Stepper",component:d,subcomponents:{FlxStepperItem:l,FlxStepperContent:o,FlxStepperList:i},decorators:[(t,{args:a})=>e.jsx("div",{style:{fontFamily:a.fontFamily},className:"flx-default-theme",children:e.jsx(t,{})})],argTypes:{fontFamily:{options:["Open Sans","Source Code Pro","Bitter"],control:{type:"select"}}}},N={args:{fontFamily:"Open Sans"}},y={...N,render:()=>e.jsxs(d,{children:[e.jsxs(i,{children:[e.jsx(l,{label:"Step 1",index:0}),e.jsx(l,{label:"Step 2",index:1}),e.jsx(l,{label:"Step 3",index:2})]}),e.jsx(o,{value:0,children:e.jsx("p",{children:'This is the contents of "Step 1"'})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 2"'})}),e.jsxs(o,{value:2,children:[e.jsx("p",{children:'This is the contents of "Step 3"'}),e.jsx("p",{children:"It can contain multiple elements"})]})]})},F={...N,render:()=>e.jsxs(d,{defaultValue:0,children:[e.jsxs(i,{children:[e.jsx(l,{label:"Step 1",index:0}),e.jsx(l,{label:"Step 2",index:1}),e.jsx(l,{label:"Step 3",index:2})]}),e.jsx(o,{value:0,children:e.jsxs("div",{children:[e.jsx("p",{children:'This is the contents of "Step 1"'}),e.jsxs(d,{children:[e.jsxs(i,{children:[e.jsx(l,{label:"Step 1.1",index:0}),e.jsx(l,{label:"Step 1.2",index:1}),e.jsx(l,{label:"Step 1.3",index:2})]}),e.jsx(o,{value:0,children:e.jsx("p",{children:'This is the contents of "Step 1.1"'})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 1.2"'})}),e.jsx(o,{value:2,children:e.jsx("p",{children:'This is the contents of "Step 1.3"'})})]})]})}),e.jsx(o,{value:1,children:e.jsx("p",{children:'This is the contents of "Step 2"'})}),e.jsxs(o,{value:2,children:[e.jsx("p",{children:'This is the contents of "Step 3"'}),e.jsx("p",{children:"It can contain multiple elements"})]})]})};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  ...StepperTemplate,
  render: () => <FlxStepper>
      <FlxStepperList>
...
} satisfies Story`,...F.parameters?.docs?.source}}};const te=["SimpleStepper","MultiStepper"];export{F as MultiStepper,y as SimpleStepper,te as __namedExportsOrder,ee as default};
