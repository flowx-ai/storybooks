...
export interface FlxDatePickerProps extends Pick<FlxAirDatePickerProps, 'minDate' | 'maxDate' | 'calendarAlwaysVisible' | 'dateFormat' | 'placeholder' | 'inputReadOnly' | 'locale' | 'container'>, Omit<ComponentPropsWithRef<'div'>, 'onChange'> {
    name?: string;
